...
Color verylightgrey = const Color(0xFFD2CECE);
Color extremelightgrey = const Color(0xB8E0E0E0);
Color lightGrey = const Color(0xFF9C9696);
Color darkGrey = const Color(0xFF666565);
